...
function formsCheck(formSelector) {
    try{
        jquery__WEBPACK_IMPORTED_MODULE_0___default()(formSelector).validate({
            rules: {
                name: 'required',
                email: {
                    required: true,
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_nav__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/nav */ "./js/modules/nav.js");
